...
from vllm.model_executor.layers.quantization.utils.mxfp8_utils import (
    xpu_mxfp8_quantize as quant_mxfp8_xpu,
)
...
# E8M0 block-scale dtype consumed by torch._scaled_mm for MXFP8 (BlockWise1x32).
...
class TorchMxFp8LinearKernel(Mxfp8LinearKernel):
    ...
    def apply_weights(
        ...
        if current_platform.is_xpu():
            ...
            x_fp8, x_scale = quant_mxfp8_xpu(input_2d)
        else:
